...
public class ParametersController implements Serializable {
    ...
    public void create() {
        persist( PersistAction.CREATE, ResourceBundle.getBundle( "/BundleParams" ).getString( "ParametersCreated" ) );
    ...
    public void update() {
        persist( PersistAction.UPDATE, ResourceBundle.getBundle( "/BundleParams" ).getString( "ParametersUpdated" ) );
    }

    public void destroy() {
        persist( PersistAction.DELETE, ResourceBundle.getBundle( "/BundleParams" ).getString( "ParametersDeleted" ) );
        if ( !JsfUtil.isValidationFailed() ) {
        ...
        if ( selected != null ) {
            ...
            try {
                ...
                if ( msg.length() > 0 ) {
                    ...
                    JsfUtil.addErrorMessage( ex, ResourceBundle.getBundle( "/BundleParams" ).getString( "PersistenceErrorOccured" ) );
                }
            } catch ( Exception ex ) {
